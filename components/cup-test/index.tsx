...
export function CupTest(props: JSX.IntrinsicElements["group"]) {
  ...
  const materialProps = useControls("test cup", {
  ...
  const cubeMaterialProps = useControls("test ice cube", {
            ...
            >
              <group scale={0.001}>
                <group position={[2.3003099, 0.02521, 0.183025]}>
                  ...
                  >
                    <MeshTransmissionMaterial map={tex} bumpMap={tex} bumpScale={3} {...cubeMaterialProps} />
                  </mesh>
                </group>
              </group>
            </group>
